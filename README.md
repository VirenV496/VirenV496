...
Backend Developement: • Node • Express • Java • Python  
Frontend Developement: • Javascript • ReactJs • Anguler  • Typescript 
• Redux • NextJs • HTML - CSS • Graph Ql • Rest • Figma
Database: • Mongo • MySQL • Firebase • Elasticsearch
Mobile Developement: • React- Native • Ionic • Android studio • X code
Mascellaneous:  • Machine learning Versioning: • Git • Git-Hub • Gitlab
Soft Skills: • Team player • Persistance • Result Oriented 
 -->
